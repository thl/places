...
gem 'acts_as_family_tree',        '1.0.3',        :git => 'git://github.com/thl/acts_as_family_tree.git',         :tag => 'v1.0.3' #:path => '../engines/acts_as_family_tree'
...
gem 'kmaps_engine',               '1.6.4',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.6.4' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.4.7',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.4.7' #:path => '../engines/places_engine'
