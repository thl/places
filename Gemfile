...
gem 'cultural_network',           '0.9.3',        :git => 'git://github.com/thl/cultural_network.git',           :tag => 'v0.9.3' #:path => '../engines/cultural_network'
...
gem 'places_engine',              '3.0.4',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.0.4' #:path => '../engines/places_engine'
