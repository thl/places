...
gem 'kmaps_engine',               '1.6.9',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.6.9' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.4.9',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.4.9' #:path => '../engines/places_engine'
