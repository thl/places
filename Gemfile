...
gem 'active_resource_extensions', '2.0.8',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.0.8' #:path => '../engines/active_resource_extensions'
gem 'acts_as_family_tree',        '1.0.4',        :git => 'git://github.com/thl/acts_as_family_tree.git',         :tag => 'v1.0.4' #:path => '../engines/acts_as_family_tree'
...
gem 'interface_utils',            '2.0.6',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.6' #:path => '../engines/interface_utils'
gem 'kmaps_engine',               '1.7.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.1' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.5.1',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.5.1' #:path => '../engines/places_engine'
