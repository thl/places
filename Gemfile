...
gem 'kmaps_engine',               '1.7.6',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.6' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.5.3',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.5.3' #:path => '../engines/places_engine'
