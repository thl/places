...
gem 'active_resource_extensions', '2.1.2',        :git => 'git://github.com/thl/active_resource_extensions.git',  :tag => 'v2.1.2' #:path => '../engines/active_resource_extensions'
gem 'acts_as_family_tree',        '1.1.0',        :git => 'git://github.com/thl/acts_as_family_tree.git',         :tag => 'v1.1.0' #:path => '../engines/acts_as_family_tree'
gem 'authenticated_system',       '2.2.3',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.2.3' #:path => '../engines/authenticated_system'
...
gem 'kmaps_engine',               '2.2.3',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v2.2.3' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.7.8',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.7.8' #:path => '../engines/places_engine'
