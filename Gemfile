...
gem 'interface_utils',            '2.1.3',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.1.3' #:path => '../engines/interface_utils'
gem 'kmaps_engine',               '2.1.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v2.1.1' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.7.4',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.7.4' #:path => '../engines/places_engine'
