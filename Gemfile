...
gem 'acts_as_family_tree',        '1.0.2',        :git => 'git://github.com/thl/acts_as_family_tree.git',        :tag => 'v1.0.2' #:path => '../engines/acts_as_family_tree'
...
gem 'cultural_network',           '0.9.4',        :git => 'git://github.com/thl/cultural_network.git',           :tag => 'v0.9.4' #:path => '../engines/cultural_network'
...
gem 'kmaps_integration',          '2.0.8',        :git => 'git://github.com/thl/kmaps_integration.git',          :tag => 'v2.0.8' #:path => '../engines/kmaps_integration'
gem 'mms_integration',            '2.0.5',        :git => 'git://github.com/thl/mms_integration.git',            :tag => 'v2.0.5' #:path => '../engines/mms_integration'
gem 'places_engine',              '3.0.5',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.0.5' #:path => '../engines/places_engine'
