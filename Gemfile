...
gem 'complex_dates',              '2.0.7',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.0.7' #:path => '../engines/complex_dates'
...
gem 'interface_utils',            '2.0.8',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.8' #:path => '../engines/interface_utils'
gem 'kmaps_engine',               '1.9.3',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.9.3' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'mms_integration',            '2.1.7',        :git => 'git://github.com/thl/mms_integration.git',             :tag => 'v2.1.7' #:path => '../engines/mms_integration'
gem 'places_engine',              '3.6.1',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.6.1' #:path => '../engines/places_engine'
