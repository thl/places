...
gem 'interface_utils',            '2.0.7',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.0.7' #:path => '../engines/interface_utils'
gem 'kmaps_engine',               '1.7.5',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.5' #:path => '../../shanti/engines/kmaps_engine'
