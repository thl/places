...
gem 'kmaps_engine',               '1.6.5',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.6.5' #:path => '../../shanti/engines/kmaps_engine'
...
gem 'places_engine',              '3.4.8',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.4.8' #:path => '../engines/places_engine'
