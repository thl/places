...
gem 'complex_scripts',            '2.0.5',        :git => 'git://github.com/thl/complex_scripts.git',            :tag => 'v2.0.5' #:path => '../engines/complex_scripts'
gem 'cultural_network',           '0.9.1',        :git => 'git://github.com/thl/cultural_network.git',           :tag => 'v0.9.1' #:path => '../engines/cultural_network'
...
gem 'places_engine',              '3.0.1',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.0.1' #:path => '../engines/places_engine'
