...
gem 'complex_dates',              '2.0.1',        :git => 'git://github.com/thl/complex_dates.git',              :tag => 'v2.0.1' #:path => '../engines/complex_dates'
...
gem 'places_engine',              '2.1.8',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v2.1.8' #:path => '../engines/places_engine'
