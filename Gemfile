...
gem 'complex_dates',              '2.1.4',        :github => 'thl/complex_dates',               :tag => 'v2.1.4' #:path => '../engines/complex_dates'
...
gem 'interface_utils',            '2.1.9',        :github => 'thl/interface_utils',             :tag => 'v2.1.9' #:path => '../engines/interface_utils'
gem 'mms_integration',            '2.2.6',        :github => 'thl/mms_integration',             :tag => 'v2.2.6' #:path => '../engines/mms_integration'
gem 'kmaps_engine',               '2.3.8',        :github => 'shanti-uva/kmaps_engine',         :tag => 'v2.3.8' #:path => '../../../thl-legacy/shanti/engines/kmaps_engine'
